    ...
    render() {
        return (
            <div>
                <BHeader />
                <div>
                    <BDialog buttonClick={ this.onDialogButtonClick } />

                    <section className="app-container mask">
                        <section className="receiver-container">
                            <img src="http://gravatar.com/avatar/21733486eab437f1e2c230537de4fb9d?d=retro"
                                title="New person" />

                            <div className="person-name">
                                <div className="talt-phrase">Talking to</div> <strong>New Person</strong>
                            </div>
                        </section>

                        <video autoPlay id="stage"></video>
                        <video autoPlay id="mirror"></video>

                        <section className="direction-toolbar">
                            <div className="camera-joystick joystick">
                                <div className="container">
                                    <i className="material-icons desc-icons" title="Camera Control">photo_camera</i>
                                    <i className="material-icons" type="foward" title="Foward">keyboard_arrow_up</i>
                                    <i className="material-icons" type="back" title="Back">keyboard_arrow_down</i>
                                    <i className="material-icons" type="left" title="Left">keyboard_arrow_left</i>
                                    <i className="material-icons" type="right" title="Right">keyboard_arrow_right</i>
                                </div>
                            </div>

                            <div className="moviment-joystick joystick">
                                <div className="container">
                                    <i className="material-icons desc-icons" title="Motors Control">airport_shuttler</i>
                                    <i className="material-icons" type="foward" title="Foward">keyboard_arrow_up</i>
                                    <i className="material-icons" type="back" title="Back">keyboard_arrow_down</i>
                                    <i className="material-icons" type="left" title="Left">keyboard_arrow_left</i>
                                    <i className="material-icons" type="right" title="Right">keyboard_arrow_right</i>
...
ReactDOM.render(<StagePage />, document.getElementById('bmate-app'));
